 ...
 * @author carlo
 */
public class JDlgGuitarraPesquisa extends javax.swing.JDialog {

    private JDlgGuitarra jDlgGuitarra;
    private GuitarraControle guitarraControle;
    /**
     * Creates new form JDlgGuitarraPesquisa
     */
    public JDlgGuitarraPesquisa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        guitarraControle = new GuitarraControle();
        Guitarra_DAO guitarra_DAO = new Guitarra_DAO();
        List lista = guitarra_DAO.listAll();
    ...
    private void jBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkActionPerformed
        ...
        Guitarra guitarra = guitarraControle.getBean(rowSel);
        jDlgGuitarra.beanView(guitarra);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgGuitarraPesquisa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgGuitarraPesquisa dialog = new JDlgGuitarraPesquisa(new javax.swing.JFrame(), true);
